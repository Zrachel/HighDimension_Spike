...
%
%   plot_training_latencies_increasing_up_the_y_axis (default = 0).  If this is set to 1, then the training latencies that are earlier in the trial
...
%==========================================================================    
  ...
  properties 
      ...
      plot_training_latencies_increasing_up_the_y_axis = 0;
    ...
    methods 
        ...
        function min_and_max_data_range = plot_results(plot_obj)
            ...
            if isfield(all_results_data, 'DS_PARAMETERS') && isfield(all_results_data.DS_PARAMETERS, 'binned_site_info');
            ...
            if isstruct(the_time_interval ) || ~isempty(curr_default_binning_parameters)
